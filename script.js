...
function getPasswordOptions() {
  ...
  function getPasswordLength() {
    passwordLength = parseInt(
      prompt(
        "Please enter the length of password. The password should be between 10 to 64 characters."
      )
    );
  ...
  function chooseCharacterTypes() {
    lowerCaseOption = confirm(
      "Include lowercase characters? ('Ok' = yes, 'Cancel' = no)"
    );
    upperCaseOption = confirm(
      "Include uppercase characters? ('Ok' = yes, 'Cancel' = no)"
    );
    numericOption = confirm(
      "Include numeric characters? ('Ok' = yes, 'Cancel' = no)"
    );
    specialCharOptions = confirm(
